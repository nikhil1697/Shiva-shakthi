...
export default function FamilySection({ onStoryClick }: FamilySectionProps) {
  return (
    <section className="bg-bg-azure py-20 lg:py-28 overflow-hidden border-t border-bronze-light/20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
          ...
          <div className="relative lg:col-span-6 flex justify-center lg:justify-start">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-80 w-80 rounded-full bg-turquoise-brand/5 blur-3xl"></div>
 
            {/* Rotating Decorative Outer Rings */}
            <motion.div 
              animate={{ rotate: 360 }}
              transition={{ duration: 50, repeat: Infinity, ease: "linear" }}
              className="absolute h-[340px] w-[340px] rounded-full border border-dashed border-bronze-light/50 pointer-events-none xs:h-[400px] xs:w-[400px] sm:h-[445px] sm:w-[445px] z-0"
            />
            <motion.div 
              animate={{ rotate: -360 }}
              transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
              className="absolute h-[350px] w-[350px] rounded-full border border-double border-turquoise-brand/20 pointer-events-none xs:h-[410px] xs:w-[410px] sm:h-[455px] sm:w-[455px] z-0"
            />
            ...
            <motion.div 
              ...
              className="relative h-[320px] w-[320px] rounded-full p-2 bg-transparent border border-bronze-light/40 shadow-none xs:h-[380px] xs:w-[380px] sm:h-[420px] sm:w-[420px] overflow-hidden flex items-center justify-center z-10 cursor-pointer group"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-10 right-4 bg-orange-vitality text-white px-6 py-4 rounded-2xl shadow-lg shadow-turquoise-brand/20 max-w-[155px] text-center transform z-20 cursor-pointer flex flex-col justify-center items-center"
            >
          ...
          <div className="lg:col-span-6 text-left space-y-6 z-10">
            ...
            <p className="text-sm leading-relaxed text-navy-dark/70 sm:text-base font-sans">
            ...
            <div className="relative border-l-2 border-turquoise-brand pl-5 py-3 my-4 bg-turquoise-brand/5 rounded-r-xl border-y border-y-transparent">
              <p className="text-sm sm:text-base font-serif italic leading-relaxed text-navy-dark/95">
            ...
            <div className="pt-2">
              <motion.button
                whileHover={{ scale: 1.03, backgroundColor: "rgba(216, 206, 184, 0.15)" }}
                whileTap={{ scale: 0.98 }}
                onClick={onStoryClick}
                className="group inline-flex items-center gap-2 rounded-full border border-bronze-light/40 bg-transparent px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-navy-dark shadow-none cursor-pointer font-sans transition-colors"
              >
                READ OUR STORY
